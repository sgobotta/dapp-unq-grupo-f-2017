  ...
  methods: {
    ...
    addOrUpdateMenu () {
      ...
      const newMenu = {
        ...
        ancestors: [this.provider.email],
        currencyName: this.currencyName,
        price: { amount: this.priceAmount, currencyName: this.currencyName },
        deliveryPrice: { amount: this.deliveryPrice, currencyName: this.currencyName },
